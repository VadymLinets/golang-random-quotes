...
func (_m *QuoteAPI) GetRandomQuote(ctx context.Context) (database.Quote, error) {
	ret := _m.Called(ctx)
	...
	if rf, ok := ret.Get(0).(func(context.Context) database.Quote); ok {
		r0 = rf(ctx)
	} else {
...
func (_c *QuoteAPI_GetRandomQuote_Call) Return(_a0 database.Quote, _a1 error) *QuoteAPI_GetRandomQuote_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *QuoteAPI_GetRandomQuote_Call) RunAndReturn(run func(context.Context) (database.Quote, error)) *QuoteAPI_GetRandomQuote_Call {
	_c.Call.Return(run)
	return _c
}
