...
// SaveQuote provides a mock function for the type QuoteapiDatabase
func (_mock *QuoteapiDatabase) SaveQuote(ctx context.Context, quote database.Quote) error {
	ret := _mock.Called(ctx, quote)
...
func (_c *QuoteapiDatabase_SaveQuote_Call) Return(err error) *QuoteapiDatabase_SaveQuote_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *QuoteapiDatabase_SaveQuote_Call) RunAndReturn(run func(ctx context.Context, quote database.Quote) error) *QuoteapiDatabase_SaveQuote_Call {
	_c.Call.Return(run)
	return _c
}
